...
if (empty($_POST["etape"])) {
  ...
  <div class="row">
    <div class="col-3 "></div>
    <div class="col-6">
      <form action="index.php?content=caisse" method="post" id="formMatricule">
  ...
  <div class="row">
    <div>
      <form action="/index.php?content=caisse" method="post" id="majActif">
  ...
  if ($verification_commande == $taille_post) {
    ?>
              <script>
                ...
                form.action = "/index.php?content=caisse";
                form.method = "post";
  ...
  foreach ($tableauRecap as &$ligne) {
    if ($ligne["valpointsjaune"] != "0") {
      ...
      $b = array(
        ...
        "Total points Jaunes"                => $ligne["valpointsjaune"],
  ...
  ?>
            <div class="row">
              ...
              <div class="col-6 text-center">
                <form action="index.php?content=caisse" method="post" id="form_retour_commande">
                  <input hidden value="1" name="etape" id="etape">
              ...
              <div class="col-6 text-center">
                <form action="index.php?content=caisse" method="post" id="formValidationCommande">
  ...
  if ($point > -1) {
    ...
    ?>
              ...
              <!-- <div class="row">
                                                                                                                                                                                    <div class="col-3 "></div>
                                                                                                                                                                                    <div class="col-6">
                                                                                                                                                                                        <form action="index.php?content=caisse" method="post" id="retourAudébut">
  ...
  unset($_POST["etape"]);
  ?>
            <script> location.replace("/index.php?content=caisse"); </script>
            <?php
