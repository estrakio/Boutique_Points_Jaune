                            ...
                            <div class="col-6">
                                <form action="/index.php?content=ajoutProduitBleu" method="post" id="formAjoutProduit">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="form-control" placeholder="code SAP" name="codeabap"
                                            required>
                                    </div>
                                    <br>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" class="form-control" placeholder="0" name="valpointsbleu"
                                            required>
                                    </div>
                                    <br>
                                    <div>
                                ...
                                <div class="card" style="width: 25rem;">
                                    <div class="card-body">
                                        ...
                                        <div class="row text-center">
                                            <div>
                                                <form action="index.php?content=ajoutProduitBleu" method="post"
